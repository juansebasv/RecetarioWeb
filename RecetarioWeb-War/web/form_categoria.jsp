            ...
            <section class="contact" id="contact">
                <div class="container">
                    <div class="heading">
                        ...
                        <img class="dividerline" src="img/sep.png" alt="">
                        <h3>Puedes crear nuevas categorias para que diferentes usuarios registren sus recetas en ellas.</h3>
                        <form action="Categoria">
                            <table columns="2" style="margin-left: 100px;float: left;margin-top: 0px" class="table table-hover">
                                <div class="form-group">
                                    <label class="col-sm-offset-3 col-md-3 control-label">Nombre Categoria *:</label>
                                    <div class="col-sm-4 col-xs-12">
                                        <input name="nameCat" type="text" maxlength="30" required="true" placeholder="Nombre Categoria" title="Nombre Categoria" class="form-control"/><br/>
                                    </div>
                                </div><br/>
                                <div class="form-group">
                                    <label class="col-sm-offset-3 col-md-3 control-label">Descripcion Categoria *:</label>
                                    <div class="col-sm-4 col-xs-12">
                                        <textarea name="desCat" type="text" maxlength="900" rows="6" required="true" placeholder="Descripcion Categoria" title="Descripcion Categoria" class="form-control"></textarea><br/>
                                    </div>
                                </div><br/>
                                <div class="form-group">
                                    <div class="col-sm-offset-5 col-sm-3 col-xs-12">
                                        <input type="submit" value="Registrar Categoria" title="Registrar Categoria" class="btn btn-warning"/>
                                    </div>
                                </div>
                            </table>
                        </form>
