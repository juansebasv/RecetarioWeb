...
<%controller.reconocerTip(client.getNombreTip());%>
            ...
            <section class="specialties" id="specialties">
                <div class="container">
                    <div class="heading text-center">
                        ...
                        <h2><%=controller.getTip().getNombretip()%></h2>
                        <img class="dividerline" src="img/sep.png" alt="">
                        <br/><h2>Descripcion:</h2>
                        <div class="row">
                            <blockquote><%=controller.getTip().getDescripciontip()%>"<cite><%=controller.getTip().getAutortip()%><br/><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></cite> </blockquote>
                        </div>
                        <i><%=controller.getTip().getFechatip()%></i>
                    </div>
                </div>
            </section>
