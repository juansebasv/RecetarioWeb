            ...
            <section class="contact" id="contact">
                <div class="container">
                    <div class="heading">
                        ...
                        <img class="dividerline" src="img/sep.png" alt="">
                        <h3>Puedes modificar la infromacion personal de tu perfil en nuestra plataforma.</h3>
                        <h5>Si solo deseas modificar un solo campo de tu información lo puedes hacer.</h5><br/>
                            ...
                            <table columns="2" style="margin-left: 100px;float: left;margin-top: 0px" class="table table-hover">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                        <input name="email" type="email" maxlength="30" placeholder="E-Mail" title="E-Mail" class="form-control"/><br/>
                                    </div>
                                </div><br/>
                                <div class="form-group">
                                    <label class="col-sm-offset-3 col-md-3 control-label">Direccion *:</label>
                                    <div class="col-sm-4 col-xs-12">
                                        <input name="direccion" type="text" maxlength="30" placeholder="Direccion" title="Direccion" class="form-control"/><br/>
                                    </div>
                                </div><br/>
                                <div class="form-group">
                                    <label class="col-sm-offset-3 col-md-3 control-label">Pais *:</label>
                                    <div class="col-sm-4 col-xs-12">
                                        <input name="pais" type="text" maxlength="30" placeholder="Pais" title="Pais" class="form-control"/><br/>
                                    </div>
                                </div><br/>
                                <div class="form-group">
                                    <label class="col-sm-offset-3 col-md-3 control-label">Ciudad *:</label>
                                    <div class="col-sm-4 col-xs-12">
                                        <input name="ciudad" type="text" maxlength="30" placeholder="Ciudad" title="Ciudad" class="form-control"/><br/>
                                    </div>
                                </div><br/><br/>
                                <div class="form-group">
                                    <div class="col-sm-offset-5 col-sm-3 col-xs-12">
                                        <input type="submit" value="Modificar" title="Modificar" class="btn btn-warning"/>
                                    </div>
                                </div>
                            </table>
                        </form>
