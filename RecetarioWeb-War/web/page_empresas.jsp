<%-- 
    Document   : page_empresa
    Created on : 15/04/2015, 10:51:19 PM
    Author     : Juan Sebastian Vega
--%>
<%@page import="com.RecetarioWeb.Entitys.Empresa"%>
...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <div class="wrapper" id="wrapper">
            ...
            <% ArrayList<Empresa> empresas = controller.getEmpresas();%>
            <!--specialties-->
            <section class="specialties" id="specialties">
                <div class="container">
                    <div class="heading text-center">
                        <img class="dividerline" src="img/sep.png" alt="">
                        <h2>Empresas Asosiadas</h2>
                        <img class="dividerline" src="img/sep.png" alt="">
                        <table style="margin-left: 100px;float: left;margin-top: 0px" class="table table-hover" >
                            <%for (int i = 0; i < empresas.size(); i++) {%>
                            <tr>
                                <td class="success"><i>Empresa #<%=(i + 1)%></i></td>
                            </tr>
                            <tr>
