            ...
            <section class="contact" id="contact">
                <div class="container">
                    <div class="heading">
                        ...
                        <img class="dividerline" src="img/sep.png" alt="">
                        <h3>Puedes cambiar tu contraseña y mantener actualizada la seguridad de tu perfil en nuestra plataforma.</h3><br/>
                        <form action="Cambiar">
                            <table columns="2" style="margin-left: 100px;float: left;margin-top: 0px" class="table table-hover">
                                <div class="form-group">
                                    <label class="col-sm-offset-3 col-md-3 control-label">Contraseña Actual *:</label>
                                    <div class="col-sm-4 col-xs-12">
                                        <input name="contrasenaAnt" type="password" maxlength="30" required="true" placeholder="Contraseña Actual" title="Contraseña Actual" class="form-control"/><br/>
                                    </div>
                                </div><br/>
                                <div class="form-group">
                                    <label class="col-sm-offset-3 col-md-3 control-label">Contraseña Nueva *:</label>
                                    <div class="col-sm-4 col-xs-12">
                                        <input name="contrasenaNue" type="password" maxlength="30" required="true" placeholder="Contraseña Nueva" title="Contraseña Nueva" class="form-control"/><br/>
                                    </div>
                                </div><br/>
                                <div class="form-group">
                                    <label class="col-sm-offset-3 col-md-3 control-label">Confirmar Contraseña *:</label>
                                    <div class="col-sm-4 col-xs-12">
                                        <input name="contrasenaConf" type="password" maxlength="30" required="true" placeholder="Confirmar Contraseña" title="Confirmar Contraseña" class="form-control"/><br/><br/>
                                    </div>
                                </div><br/>
                                <div class="form-group">
                                    <div class="col-sm-offset-5 col-sm-3 col-xs-12">
                                        <input type="submit" value="Cambiar Contraseña" title="Cambiar Contraseña" class="btn btn-warning"/>
                                    </div>
                                </div>
                            </table>
                        </form>
