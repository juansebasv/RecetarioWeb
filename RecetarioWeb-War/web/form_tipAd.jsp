                    ...
                    <form action="ServletTip" method="post">
                        <table columns="2" style="margin-left: 100px;float: left;margin-top: 0px" class="table table-hover">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 col-xs-12">
                                    <textarea name="descripTip" type="text" maxlength="980" rows="6" required="true" placeholder="Descripcion Tip" title="Descripcion Tip" class="form-control"></textarea><br/>
                                </div>
                            </div><br/>
                            <div class="form-group">
