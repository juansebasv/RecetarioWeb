...
<%@page import="com.RecetarioWeb.Entitys.Tip"%>
...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <div class="wrapper" id="wrapper">
            ...
            <% ArrayList<Tip> tips = controller.getTips();%>
            <!--specialties-->
                ...
                <div class="container">
                    <div class="heading text-center">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td class="success"><i>Tip #<%=(i + 1)%></i></td>
                            </tr>
                            <tr>
                            <form action="ReconocerServlet" method="post">
                                <td><img src="http://wowthemes.net/demo/leroy/img/dummies/10.jpg" alt="" width="250" height="250" class="img-rounded"/></td>
                                <td><input type="radio" name="redirec" value="<%=tips.get(i).getNombretip()%>"/><i><font style="color:#398439 " size="5"><strong><%=tips.get(i).getNombretip()%></strong></font></i><br/>
                                    <i><%=controller.formatText(tips.get(i).getNombretip())%></i><br/>
